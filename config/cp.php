        ...
        'child' => array(
            ...
            'set' => array('name' => '站点配置', 'checked' => false, 'display' => true, 'act' => 'default', 'class' => 'fa fa-circle-o',
                'child' => array(
                    ...
                    'areaList' => array('name' => '地区列表', 'checked' => false, 'display' => false, 'url' => 'main/set/areaList', 'act' => 'default'),
                    'addArea' => array('name' => '添加地区', 'checked' => false, 'display' => false, 'url' => 'main/set/addArea', 'act' => 'default'),
                    'editArea' => array('name' => '修改地区', 'checked' => false, 'display' => false, 'url' => 'main/set/editArea', 'act' => 'default'),
                ),
            ),
        ),
    ),
        ...
        'child' => array(
            ...
            'channel' => array('name' => '渠道管理', 'checked' => false, 'display' => true, 'act' => 'default', 'class' => 'fa fa-circle-o',
                'child' => array(
                    ...
                    'delChannel' => array('name' => '删除渠道', 'checked' => false, 'display' => true, 'url' => 'game/channel/delChannel', 'act' => 'default'),
                ),
            ),
        ...
        'child' => array(
            'index' => array('name' => '房间管理', 'checked' => false, 'display' => true, 'act' => 'default', 'class' => 'fa fa-circle-o',
                'child' => array(
                    ...
                    'channelList' => array('name' => '渠道', 'checked' => false, 'display' => false, 'url' => 'room/index/channelList', 'act' => 'login'),
                ),
            ),
